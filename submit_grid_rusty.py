...
SBATCH_DEFAULTS = {
    ...
    "mail-user":     "slurm_notify-aaaaq7zc7ou7enlnbsexygd3he@sdss5.slack.com",  # address for those notifications
}

MODULE_LINES = """\
module purge
module load python/3.12.9 uv/0.7.13
source /mnt/home/asaydjari/uv_env/DIB/bin/activate"""

PYTHON_SCRIPT = "/mnt/home/asaydjari/gitcode/DIB/run_emcee_asym_both_newerrs_rusty.py"
