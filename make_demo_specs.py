...
# # ── Parameter grid ────────────────────────────────────────────────────────
GRID_T     = [5, 10, 20]
GRID_A     = [0.08, 0.04, 0.02]
GRID_b_fac = [0.98, 0.9, 0.5, 0.1]   # B = A × b_fac
GRID_c_fac = [0.98, 0.9, 0.5, 0.1]   # C = B × c_fac
GRID_fA    = [1.0, 0.98, 0.92]
GRID_fB    = [1.0, 0.98, 0.92]
GRID_fC    = [1.0, 0.98, 0.92]
GRID_lt    = [0.01]          # Lorentz width (cm⁻¹)
GRID_sig   = [0.01]               # Gaussian width (cm⁻¹)
