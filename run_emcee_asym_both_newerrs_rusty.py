...
TEMP_DIR = osp.expanduser(f"/dev/shm/pgo_temppy_{TEMP_SUFFIX}")
...
backend_file = osp.expanduser(f"/mnt/ceph/users/sdssv/work/asaydjari/2026_04_09/chains/{args.dib}_run_{TEMP_SUFFIX}.h5")
